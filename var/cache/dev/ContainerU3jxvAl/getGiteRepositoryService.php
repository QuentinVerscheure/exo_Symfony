 ...
 */
class getGiteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\GiteRepository' shared autowired service.
     *
     * @return \App\Repository\GiteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'GiteRepository.php';

        return $container->privates['App\\Repository\\GiteRepository'] = new \App\Repository\GiteRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
